    ...
    <div class="container py-4">
        ...
        <form action="{{url('usuarios')}}" method="post">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="TipoIdentificacion" id="TipoIdentificacion" value{{old('TipoIdentificacion')}}>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="NumeroIdentificacion" id="NumeroIdentificacion" value{{old('NumeroIdentificacion')}}>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="profesion" id="profesion" value{{old('profesion')}}>
                </div>
            </div>
